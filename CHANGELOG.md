...
_Pending. Addressing [#6](https://github.com/patiently/anti-tangent-mcp/issues/6): chunker identity reconciliation, `model_override` UX, `validate_completion` reviewer over-strictness._
