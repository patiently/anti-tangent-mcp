...
---
   ...
   1. Definitions.
      ...
      and additions to that Work or Derivative Works thereof, and any original
      works of authorship submitted to, or designated in writing by, Licensor as
      part of Contribution to Licensor for inclusion in the Work by Licensor or
      its representatives (including but not limited to patches, additions,
      comments, and other works of authorship).

      "Contributor" shall mean Licensor and any Legal Entity on behalf of
      whom a Contribution has been received by Licensor and subsequently
      incorporated within the Work.

      "Licensed Patents" shall mean the patent claims of a Contributor that
      are necessarily infringed by the Contribution of that Contributor to
      the Work to which such Contribution applies.
